...
class FlyTrajectory:
    def __init__(self, wp_dir):
        ...
        self.path.header.frame_id = "global_nwu"
    ...
    def chgwpdirCallback(self, msg):
       if msg.data == True:
          self.wp_idx += 1
          split_lines = self.wp_dir.split(".")
          print(split_lines)
          if split_lines[0][-1].isnumeric():
             split_lines[0]= split_lines[0][:-1] + str(self.wp_idx)
          else:
             split_lines[0] = split_lines[0] + str(self.wp_idx)
          
          self.wp_dir = split_lines[0] + "." + split_lines[1]
...
if __name__ == '__main__':
    waypoint_dir = '/home/yanrui89/storage/catkin_offb/src/px4_offb_ctrl/data/straight_ahead.txt'
    main(waypoint_dir)